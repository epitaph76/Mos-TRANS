    ...
    <main className="main-area">
      ...
      <div className="workspace">
        <section className="primary-panel">
          {view === 'map' ? <TransportMap vehicles={displayVehicles} selected={selected} selectedId={selectedId} onSelect={select} showRoutes={showRoutes && mode !== 'live'} setShowRoutes={setShowRoutes} collapsed={monitorCollapsed} network={network} /> : <DataView view={view} vehicles={displayVehicles} select={select} />}
        </section>
